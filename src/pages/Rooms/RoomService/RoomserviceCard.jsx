...
const RoomserviceCard = ({roomservice}) => {
  ...
  return (
    ...
    <div className=' mx-auto bg-[#cccff3]  text-black font-bold rounded-3xl shadow-xl'>
         <div className="grid rounded-3xl max-w-sm shadow-sm flex-col">
      <img
          src={roomimg}
          width="390"
          height="200"
      ...
      <div className="group p-6 grid z-10">
        <h1
          href=""
          className="text-cyan-700 font-bold sm:text-2xl line-clamp-2"
        >
       {Name}
        </h1>
        <span className=" pt-2 font-semibold gap-3">
          
        <div className="badge badge-secondary lowercase">Price: {Price}$</div>
        <div className="badge badge-outline ">{offers}</div>
        </span>
        <div className="h-28">
